...
if ( ! function_exists( 'flexi_setup' ) ) :
	...
	function flexi_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'flexi' ),
		) );
 ...
 */
function flexi_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'flexi_content_width', 640 );
}
add_action( 'after_setup_theme', 'flexi_content_width', 0 );
...
function flexi_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'flexi' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'flexi' ),
