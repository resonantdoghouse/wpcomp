	...
	<div id="primary" class="content-area">
		<main id="main" class="site-main" role="main">
			...
			<section class="home-hero">
				<img src="<?php echo get_template_directory_uri() . '/images/redstar-logo-full.svg'?>" class="logo" alt="Inhabitent full logo" />
			</section>
							...
							<?php foreach( $news_posts as $post ) : setup_postdata( $post ); ?>
								<li>
									...
									<div class="post-info-wrapper">
										<span class="entry-meta"><?php redstar_posted_on(); ?> / <?php comments_number( '0 Comments', '1 Comment', '% Comments' ); ?></span>
