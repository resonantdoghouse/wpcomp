        ...
        <header id="masthead" class="site-header" role="banner">
            ...
            <div class="site-header-main">
                ...
                <ul class="mega-menu">
					...
					if ( isset( $locations['dev_megamenu'] ) ) {
						$menu = get_term( $locations['dev_megamenu'], 'nav_menu' );
						if ( $items = wp_get_nav_menu_items( $menu->name ) ) {
							foreach ( $items as $item ) {
								echo "<li class=\"mega-menu__item\">";
								echo "<a href=\"{$item->url}\">{$item->title}</a>";
								if ( is_active_sidebar( 'mega-menu-widget-area-' . $item->ID ) ) {
									echo "<ul id=\"mega-menu-{$item->ID}\" class=\"mega-menu__item__content\">";
